<?php
/*
Template Name: Шаблон для Главной стр.
*/
          ...
          <ul class="cards__list row">
            <?php
              while($query->have_posts()):
                ...
                $default_bg = _si_assets_path('img/index__cards_card2.jpg');
                $bg = $bg ? 
            ...
            <li class="card<?php echo $profit_class; ?>" <?php echo $bg; ?>>
              ...
              <p class="card__time"> 
                <?php the_field('club_card_start'); ?> 
                  &ndash;
                <?php the_field('club_card_end'); ?>
              </p>
